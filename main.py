...
def user_post():
    ...
    return render_template('user_post.html',msg=msg,data=data,act=act,pdata=pdata)
...
def edit_profile():
    ...
    if request.method=='POST':
        ...
        sql=("update register set name=%s, dob=%s,mobile=%s,email=%s,city=%s,profession=%s,aadhar=%s,status=1 where uname=%s")
